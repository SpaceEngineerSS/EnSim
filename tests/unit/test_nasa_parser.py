...
from ensim.core.types import SpeciesData
from ensim.utils.nasa_parser import (
...
class TestSpeciesDataClass:
    ...
    def test_species_repr(self):
        ...
        species = SpeciesData(
            name="TEST", molecular_weight=28.0, temp_ranges=[(200.0, 1000.0, 6000.0)]
        )
    ...
    def test_default_temperature_range(self):
        ...
        species = SpeciesData(name="TEST", molecular_weight=28.0)
