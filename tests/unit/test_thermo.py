...
class TestNASAPolynomialCalculations:
    ...
    def test_temperature_range_switching(self, h2o):
        ...
        props_low = get_thermo_properties(T_low, h2o.coeffs_low, h2o.coeffs_high, T_mid=1000.0)
        props_high = get_thermo_properties(T_high, h2o.coeffs_low, h2o.coeffs_high, T_mid=1000.0)
    ...
    def test_gibbs_free_energy_consistency(self, h2o):
        ...
        assert abs(g_rt - expected_g_rt) < 1e-10, f"G/(RT) = {g_rt}, expected {expected_g_rt}"
