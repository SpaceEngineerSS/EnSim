...
- Editable reference vehicle templates
"""
...
class MultiStageWidget(QWidget):
    ...
    Features:
    - Add/remove stages
    - Load editable reference vehicles
    ...
    def _setup_ui(self):
        ...
        self.preset_combo.addItems(
            [
                "Custom",
                "Medium Lift Reference (2-stage)",
                "Heavy Lift Reference (3-stage)",
    ...
    def _load_preset(self, index: int):
        ...
        if index == 1:
            vehicle = create_medium_lift_reference()
        elif index == 2:
            vehicle = create_heavy_lift_reference()
        elif index == 3:  # Small Launcher
            configs = [
                {
                    "dry_mass": 2000,
                    "propellant_mass": 20000,
                    "thrust_sl": 300000,
                    "thrust_vac": 330000,
                    "isp_sl": 270,
                    "isp_vac": 295,
    ...
    def _update_vehicle(self):
        ...
        try:
            ...
            logger.exception("Could not build the staged vehicle")
    ...
    def get_vehicle(self) -> MultiStageVehicle | None:
        ...
        try:
            ...
            logger.exception("Could not read the staged-vehicle configuration")
            return None
