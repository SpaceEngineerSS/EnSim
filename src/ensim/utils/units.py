...
ISP_UNITS = {
    ...
    "m/s": UnitDefinition(
        "m/s (exhaust vel)", "m/s", UnitCategory.SPECIFIC_IMPULSE, 1 / 9.80665, 9.80665
    ),
    "ft/s": UnitDefinition(
        "ft/s (exhaust vel)",
        "ft/s",
        UnitCategory.SPECIFIC_IMPULSE,
        0.3048 / 9.80665,
        9.80665 / 0.3048,
    ),
    "N·s/kg": UnitDefinition(
        "N·s/kg", "N·s/kg", UnitCategory.SPECIFIC_IMPULSE, 1 / 9.80665, 9.80665
    ),
...
HEAT_FLUX_UNITS = {
    ...
    "BTU/h·ft2": UnitDefinition(
        "BTU/(h·ft²)", "BTU/(h·ft²)", UnitCategory.HEAT_FLUX, 3.15459, 0.316998
    ),
}
