...
def _run_single_simulation(args: Tuple) -> SimulationResult:
    ...
    from src.core.rocket import Rocket, NoseCone, BodyTube, FinSet, EngineMount, Fin
...
def plot_dispersion(result: DispersionResult, save_path: Optional[str] = None) -> None:
    """
