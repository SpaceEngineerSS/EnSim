...
from PyQt6.QtWidgets import (
    ...
    QDockWidget, QLabel, QTabWidget, QTextEdit,
    QFrame, QGridLayout, QSplitter, QStatusBar,
...
class MainWindow(QMainWindow):
    ...
    def _load_preset(self, preset):
        ...
        from ...core.presets import EnginePreset
    ...
    def _set_unit_system(self, system: str):
        ...
        from ...core.units import get_units, UnitSystem
