...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QLabel, QSplitter, QWidget, QHeaderView, QFrame,
    QComboBox, QGroupBox
)
...
class DesignSnapshot:
    ...
    thrust_curve_time: Optional[np.ndarray] = None
    thrust_curve_thrust: Optional[np.ndarray] = None
...
class SnapshotManager:
    ...
    def get(self, index: int) -> Optional[DesignSnapshot]:
...
class CompareWindow(QDialog):
    ...
    def _update_table(self, snap1: Optional[DesignSnapshot], 
                      snap2: Optional[DesignSnapshot]):
    ...
    def _update_plot(self, snap1: Optional[DesignSnapshot], 
                     snap2: Optional[DesignSnapshot]):
