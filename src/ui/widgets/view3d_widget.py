...
from src.core.propulsion import get_nozzle_geometry, get_nozzle_profile
from src.core.constants import GAS_CONSTANT

# Try to import plume renderer
try:
    from src.ui.viz.plume_render import PlumeRenderer, PlumeConditions
...
class NozzleView3D(QWidget):
    ...
    def _add_plume(
        ...
        from src.core.propulsion import solve_mach_from_area_ratio_supersonic, calculate_exit_conditions
